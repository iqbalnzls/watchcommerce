...
func (_m *ProductServiceIFaceMock) Get(req *dto.GetProductRequest) (dto.GetProductResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*dto.GetProductRequest) (dto.GetProductResponse, error)); ok {
		return rf(req)
	}
...
func (_m *ProductServiceIFaceMock) GetByBrandID(req *dto.GetProductByBrandIDRequest) ([]dto.GetProductResponse, error) {
	...
	var r0 []dto.GetProductResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(*dto.GetProductByBrandIDRequest) ([]dto.GetProductResponse, error)); ok {
		return rf(req)
	}
...
type mockConstructorTestingTNewProductServiceIFaceMock interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewProductServiceIFaceMock(t mockConstructorTestingTNewProductServiceIFaceMock) *ProductServiceIFaceMock {
